...
public class EditBenefitsValueById implements Task {
    private final String id;
    private final String editBenefitValue;
    public EditBenefitsValueById(String id, String editBenefitValue) {
        this.id = id;
    ...
    public static EditBenefitsValueById editBenefitsById(String id, String editBenefitValue) {
        return instrumented(EditBenefitsValueById.class, id, editBenefitValue);
  }
}
