...
public class CreateAuxiliarRole implements Task {
    private final String newAuxiliarRole;
    public CreateAuxiliarRole(String newAuxiliarRole) {
        this.newAuxiliarRole = newAuxiliarRole;
}
...
@Override
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Enter.theValue(newAuxiliarRole).into(BOX_EDIT_NEW_ROLE),
                Click.on(BTN_SAVE_ROLE),
                Wait.aTime(5000)
        );
    }
    public static CreateAuxiliarRole createAuxiliarRole(String newAuxiliarRole) {
        return instrumented(CreateAuxiliarRole.class, newAuxiliarRole);
  }
}