...
public class CreateAdminUserRole implements Task {
    private final String newAdminUser;
    private final String adminRole;
    public CreateAdminUserRole(String newAdminUser, String adminRole) {
...
@Override
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Enter.theValue(newAdminUser).into(BOX_EDIT_NEW_USER),
    ...
    public static CreateAdminUserRole createNewAdminUser(String userByFilter, String adminRole) {
        return instrumented(CreateAdminUserRole.class, userByFilter, adminRole);
  }
}