...
public class CreateNullRole implements Task {
...
@Override
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Enter.theValue("").into(BOX_EDIT_NEW_ROLE),
                Click.on(BTN_SAVE_ROLE),
                Wait.aTime(5000)
        );
    }
    public static CreateNullRole createNullRole() {
        return instrumented(CreateNullRole.class);
  }
}