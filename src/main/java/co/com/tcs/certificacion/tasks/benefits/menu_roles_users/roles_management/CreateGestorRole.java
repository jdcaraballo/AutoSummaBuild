...
public class CreateGestorRole implements Task {
    private final String newGestorRole;
    public CreateGestorRole(String newGestorRole) {
        this.newGestorRole = newGestorRole;
}
...
@Override
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Enter.theValue(newGestorRole).into(BOX_EDIT_NEW_ROLE),
                Click.on(BTN_SAVE_ROLE),
                Wait.aTime(5000)
        );
    }
    public static CreateGestorRole createGestorRole(String newGestorRole) {
        return instrumented(CreateGestorRole.class, newGestorRole);
  }
}